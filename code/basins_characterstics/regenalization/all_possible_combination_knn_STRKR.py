...
# Load data
df = pd.read_excel("/mnt/c/Users/pouria/Desktop/UTWI/basins_charactristics/regenalization/shomal+namak.xlsx", sheet_name="Sheet12")
...
selected_by_corr = corr_with_target[abs(corr_with_target) > 0.1].index.tolist()
...
# Save results
results_df_sorted.to_excel("/mnt/c/Users/pouria/Desktop/UTWI/basins_charactristics/regenalization/shomal_namk/top_3_feature_models_parallel_knn_ERAIN.xlsx", index=False)
