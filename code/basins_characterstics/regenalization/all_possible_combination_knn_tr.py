...
X_raw = df.drop(columns=["Tr", "Point_ID"], errors='ignore')
y = df["Tr"]
...
selected_by_corr = corr_with_target[abs(corr_with_target) > 0.23].index.tolist()
...
# Save results
results_df_sorted.to_excel("/mnt/c/Users/pouria/Desktop/UTWI/basins_charactristics/regenalization/shomal_namk/top_3_feature_models_parallel_knn_Tr.xlsx", index=False)
