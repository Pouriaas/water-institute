...
combs = list(combinations(X_final.columns, 5))
...
# Save results
results_df_sorted.to_excel("/mnt/c/Users/pouria/Desktop/UTWI/basins_charactristics/regenalization/shomal_namk/top_5_feature_models_parallel_Tc.xlsx", index=False)
